...
//Call the inherited model to update
bool WorldGui::UpdateModel() {
	return World::Update();
}
...
{ 
  ...
  // inherit
  //Removed inheritance from updates (They are explicitly performed by RHD)
  bool done = false; //World::Update();
