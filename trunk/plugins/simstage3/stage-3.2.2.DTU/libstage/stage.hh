  ...
  */
  ...
  public:
    ...
    virtual Model* RecentlySelectedModel() const;
	 virtual float GetSpeedup() {return speedup; } //Get the simulation speedup factor
  ...
  public:
    ...
    Model* GetChild( const std::string& name ) const;
	 ...
	 /**Get the number of model updates since simulation start */
	 uint32_t   GetUpdates()     { return updates; }
  ...
  public:
	 ...
	 public:
		...
		stg_usec_t interval; ///< Time interval  between updates (TODO: is this used?) It is now implemented by DTU!
	 };
