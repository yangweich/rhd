...
Model::Model( World* world,
  ...
  disabled(false),
    ...
    id( Model::count++ ),
    interval(world->sim_interval), // Now derived from world model!
    interval_energy(world->sim_interval), // Now derived from world model
    interval_pose(world->sim_interval), // Now derived from world model!
    last_update(0),
	 updates(0),
	 log_state(false),
    map_resolution(0.1),
