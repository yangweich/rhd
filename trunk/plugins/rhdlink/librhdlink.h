 ...
 ***************************************************************************/
  ...
  */
  ...
  int *             readArrayNamedLink(char *);
  int               writeValueLink(int, int, int);
  int               writeValueNamedLink(char *, int, int);
  int               writeArrayLink(int, int, int*);
  int               writeArrayNamedLink(char *,int, int*);
  int               isReadLink(int);
  int               isReadNamedLink(char *);
