...
// Porting - field steer
// port F.6: 1 = read enable rs232
// port F.7: 1 = transmit enable rs232
// RX port F = 0b0100 0000
// TX port F = 0b1000 0000
#define DIR_RXD  PORTF &= ~(0x80), PORTF |= 0x40
#define DIR_TXD  PORTF &= ~(0x40), PORTF |= 0x80
